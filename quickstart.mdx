...
description: "Run Herm with bunx, install it globally with Bun or npm, connect to Hermes Agent, navigate Chat, Sessions, Config, Automation, and Eikon, and send a message."
---
