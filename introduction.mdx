...
Herm organises its interface into five top-level tabs. Press <kbd>Alt</kbd>\+<kbd>←</kbd> / <kbd>Alt</kbd>\+<kbd>→</kbd> to cycle between them, or jump directly with <kbd>Alt</kbd>\+<kbd>1</kbd> through <kbd>Alt</kbd>\+<kbd>5</kbd>.
