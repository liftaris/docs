...
description: "Browse the Sessions tab to resume, rename, delete, and search sessions, inspect loaded context, lineage, token usage, models, tools, and cost analytics."
---
