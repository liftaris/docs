...
description: "Navigate the Profiles & Automation tab to triage kanban tasks, dispatch workers, switch Hermes profiles, watch live delegation, and schedule cron jobs."
---
