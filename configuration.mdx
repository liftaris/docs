---
title: "Herm configuration"
sidebarTitle: "Configuration"
description: "Environment variables Herm reads, local preference paths, and when to use overrides."
---
...
| `HERMES_KANBAN_ATTACHMENTS_ROOT` | Override the directory Herm treats as the kanban attachments root when rendering task attachments. Defaults to each board's `attachments/` directory. Files stored outside the root are listed but not linked. |
