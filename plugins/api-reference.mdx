...
A per-plugin error boundary catches slot renderers that throw. The slot renders empty (or falls back to the host default), and the rest of the shell keeps working.
