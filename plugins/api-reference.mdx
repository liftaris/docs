...
description: "Reference the current Herm bundled plugin API, including slots, routes, commands, events, UI helpers, KV state, themes, gateway access, rasterizers, and lifecycle cleanup."
---
