...
description: "Type / in the Herm composer to open local client commands and gateway-discovered commands for sessions, skills, plugins, and MCP prompts."
---
...
| `/yolo` | None | `None` | Toggle approval bypass |
