...
sidebarTitle: "Themes"
description: "Browse Herm themes, use the live picker, fix tmux color issues, and switch skins that pair a theme with an eikon preset."
---

Herm ships with dozens of built-in color themes. The picker previews themes without restarting, then stores your choice in `~/.hermes/herm/tui.json` or `$HERM_CONFIG_DIR/tui.json`.
